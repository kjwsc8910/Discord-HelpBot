...
mybot.on("message", function(message){
	...
	if(message.content === "!about")
		mybot.reply(message, "This bot is made by KJHard -KJ Hardwere- (KJ Woledgesinclair!) for the open-source community. All code is availiable at: https://github.com/benjisoft/Discord-HelpBot and is coded in Javascript using the discord.js library availiable at: https://github.com/hydrabolt/discord.js/")
});
